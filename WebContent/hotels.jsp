...
<title>Hotels Display Page</title>
...
%>
<div class="container">
<a class="btn btn-outline-primary" href="add_hotel.jsp" role="button">Add New Hotel</a>
</div>
<%
}
%>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="card">
                ...
                <img src="getImageHotel.jsp?hotelID=<%= resultSet.getInt("hotelID") %>" class="card-img-top img-thumbnail" alt="">
                <div class="card-body">
                    <h5 class="card-title"><%= resultSet.getString("hotelName")%></h5>
                    <p class="card-text"><%= resultSet.getString("hotelDescription")%></p>
                    <a href="display_hotel.jsp?hotelID=<%= resultSet.getInt("hotelID") %>">View</a>
                    <%
                    if(session.getAttribute("login").equals("admin")) {
                    %>

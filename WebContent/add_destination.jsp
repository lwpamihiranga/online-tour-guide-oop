...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container">
        <form action="AddDestinationServlet" method="POST" name="add_destination_form" enctype="multipart/form-data">
            <div class="form-group">
                <label for="destinationName">Destination Name</label>
                <input type="text" class="form-control" name="destinationName" id="destinationName" placeholder="Destination Name">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="description" id="description" rows="5" placeholder="Add destination description"></textarea>
            </div>
            <div class="form-group">

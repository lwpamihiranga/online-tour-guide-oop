...
%>
	<div class="card">
    	<img src="getImageRestaurant.jsp?restaurantID=<%= resultSet.getInt("restaurantID") %>" class="card-img-top" alt="">
        <div class="card-body">
        	<h5 class="card-title"><%= resultSet.getString("restaurantName")%></h5>
        	<p class="card-text">Location: <%= resultSet.getString("restaurantLocation")%></p>
        	<p class="card-text">Cuisine Type: <%= resultSet.getString("cuisineType")%></p>
        	<p class="card-text">Rating: <%= resultSet.getString("restaurantRating")%></p>

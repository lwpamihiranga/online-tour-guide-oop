...
<title>Restaurants Display Page</title>
...
%>
<div class="container">
<a class="btn btn-outline-primary" href="add_restaurant.jsp" role="button">Add New Restaurant</a>
</div>
<%
}
%>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="card">
                ...
                <img src="getImageRestaurant.jsp?restaurantID=<%= resultSet.getInt("restaurantID") %>" class="card-img-top img-thumbnail" alt="">
                <div class="card-body">
                    <h5 class="card-title"><%= resultSet.getString("restaurantName")%></h5>
                    <p class="card-text"><%= resultSet.getString("restaurantDescription")%></p>
                    <a href="display_restaurant.jsp?restaurantID=<%= resultSet.getInt("restaurantID") %>">View</a>
                    <%
                    if(session.getAttribute("login").equals("admin")) {
                    %>
                    <a href="update_restaurant.jsp?restaurantID=<%= resultSet.getInt("restaurantID") %>">Edit</a>
                    <a href="DeleteRestaurantServlet?restaurantID=<%= resultSet.getInt("restaurantID") %>">Delete</a>
                    <%
                    }
                    %>
                </div>

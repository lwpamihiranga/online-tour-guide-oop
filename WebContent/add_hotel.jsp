...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <h2 style="width: 17%; margin-left: auto; margin-right: auto;">Add New Hotel</h2>

    <div class="container">
        <form action="AddHotelServlet" method="POST" name="add_hotel_form" enctype="multipart/form-data">
            <div class="form-group">
                <label for="hotelName">Hotel Name</label>
                <input type="text" class="form-control" name="hotelName" id="hotelName" placeholder="Hotel Name">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="description" id="description" rows="5" placeholder="Add hotel description"></textarea>
            </div>
            <div class="form-group">
